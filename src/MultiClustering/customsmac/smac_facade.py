...
class SMAC(object):
    ...
    def __init__(self,
        ...
        # if isinstance(acquisition_function_optimizer, InterleavedLocalAndRandomSearch):
            acquisition_function_optimizer.random_search.acquisition_function = acquisition_function
            acquisition_function_optimizer.local_search.acquisition_function = acquisition_function
