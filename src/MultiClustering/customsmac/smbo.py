...
class SMBO(object):
    ...
    def run(self):
        ...
        while True:
            ...
            # print("Ys: " + str(",".join([x[0]] for x in Y)))
            print("Mx: " + str(self.acq_optimizer.max_acq_value))
            print("\n")
            ...
            # print("len of challengers: " + str(len(challengers)))
    ...
    def choose_next(self, X: np.ndarray, Y: np.ndarray,
        ...
        challengers = self.acq_optimizer.maximize(
            self.runhistory, self.stats, self.expansion_number
        )
        return challengers
